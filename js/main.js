...
var loader = function() {
  ...
  $(".site-loader-wrap").delay(200).fadeOut("slow");
	$("#hl3--overlayer").delay(200).fadeOut("slow");	
}
...
var siteMenuClone = function() {
	...
	setTimeout(function() {
		...
		var counter = 0;
    $('.hl3--site-mobile-menu .has-children').each(function(){
      var $this = $(this);
...
var mobileToggleClick = function() {
  ...
  // click outisde offcanvas
    ...
    var container = $(".hl3--site-mobile-menu");
...
var onePageNavigation = function() {
  var navToggler = $('.site-menu-toggle');
 	$("body").on("click", ".hl3--site-nav .site-nav-ul li a[href^='#'], .smoothscroll[href^='#'], .hl3--site-mobile-menu .site-nav-wrap li a[href^='#']", function(e) {
	...
	$.ajax({
		...
		success: function(html) {
			...
			pSingleHolder.append(
				...
				'" class="portfolio-single-inner"><span class="hl3--close-portfolio js-close-portfolio d-flex align-items-center"><span class="close-portfolio-label">Back to Portfolio</span><span class="icon-close2 wrap-icon-close"></span></span>' + getHTMLContent + '</div>'
			);
...
var stickyFillPlugin = function() {
	var elements = document.querySelectorAll('.hl3--sticky');
